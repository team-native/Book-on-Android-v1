...
interface BookRemoteDataSource {
    ...
    suspend fun todayRecommendations(): NetworkResult<TodayRecommendationsDto>
    suspend fun purchaseLinks(bookId: Long): NetworkResult<PurchaseLinkListDto>
    ...
    suspend fun extendLoan(loanId: Long): NetworkResult<LoanExtensionDto>
}
class BookRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun todayRecommendations() = executor.execute { publicBookApiService.todayRecommendations() }
    override suspend fun purchaseLinks(bookId: Long) = executor.execute { publicBookApiService.purchaseLinks(bookId) }
    ...
    override suspend fun extendLoan(loanId: Long) = executor.execute { authenticatedBookApiService.extendLoan(loanId) }
}
