...
internal fun sampleHomeUiState() = BookOnHomeScreenUiState(
    userName = "홍길동",
    notice = BookOnHomeSectionUiState.Content(
    ...
    recommendation = BookOnHomeSectionUiState.Content(
        BookOnAiRecommendationUiModel(
            description = "홍길동님의 대출 이력을 분석해 골랐어요",
            books = listOf(
    ...
    popularBooks = BookOnHomeSectionUiState.Content(
        listOf(
